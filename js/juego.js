...
(()=>{
      ...
      btnPedir.addEventListener("click", function () {      // funcion encargada de programar la funcion del boton de pedir, la cual realiza el
      ...
      const mensajes =()=>{
        ...
        btnnuevo.addEventListener("click", function (){
          ...
          puntosJugador          = 0;
          puntosComputadora      = 0;
          puntosJug[0].innerText = 0;
          puntosJug[1].innerText = 0;
      ...
      /**
       * (function(){     (()=>{      se raliza para que no puedan hacer solicitudes a desde consola a los datos
         })();            })();       
                
      * Estas dos funciones son funciones Auto 
        invocadas 
      */
